...
class mymf:
    ...
    #     oc = flopy.modflow.ModflowOc(mf, stress_period_data=spd, compact=True)
        ...
        self.obs =   [[0, 31, 49],
                     ...
                     [0, 11, 40],
                     [0, 31, 40]]
        btn = flopy.mt3d.Mt3dBtn(mt, icbund=1, ncomp=2, mcomp=2,
                                 prsity=prsity, sconc=0., sconc2=0., species_names=['TCE', 'PCE'],
        ...
        trpt = 0.3
        trpv = 0.03
        dsp = flopy.mt3d.Mt3dDsp(mt, al=al, trpt=trpt, trpv=trpv, dmcoef=1.e-9, dmcoef2=1.e-9)#dmcoef: molecular diffusion
        lambda1 = 0.
        ...
        ssm = flopy.mt3d.Mt3dSsm(mt, mxss=250, stress_period_data=c_spd)
